...
export const userEmailSelector = (state: IStore): string | undefined => state.user.email
export const userIsLoadingSelector = (state: IStore): boolean => state.user.isLoading
export const userIsSignedInSelector = (state: IStore): boolean => Boolean(state.user.email)
